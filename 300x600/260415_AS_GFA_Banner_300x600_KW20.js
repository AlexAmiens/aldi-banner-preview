...
lib.ssMetadata = [
		{name:"260415_AS_GFA_Banner_300x600_KW20_atlas_1", frames: [[0,0,600,1200],[0,1202,600,1200],[0,2404,600,1200],[602,0,600,1200],[602,1202,600,1200],[602,2404,600,1200],[1204,0,600,1200]]}
];
...
(lib.farbe = function() {
	this.initialize(ss["260415_AS_GFA_Banner_300x600_KW20_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(94).to({_off:false},0).wait(60));
...
}).prototype = getMCSymbolPrototype(lib.CLICKABLE, new cjs.Rectangle(0,0,300,600), null);
...
// stage content:
(lib.WIEDERHERGESTELLT_260415_AS_GFA_Banner_300x600_KW20 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(44).to({startPosition:44},0).to({x:-159.95,startPosition:54},10,cjs.Ease.quadIn).to({_off:true},1).wait(194));

	// BURRATA
	this.instance_2 = new lib.BURRATA("synched",0);
	this.instance_2.setTransform(150,300,1,1,0,0,0,150,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(44).to({x:461,startPosition:44},0).to({x:150,startPosition:54},10,cjs.Ease.quadIn).wait(40).to({startPosition:94},0).to({x:-155.95,startPosition:104},10,cjs.Ease.quadIn).to({_off:true},1).wait(144));

	// SIEGER
	this.instance_3 = new lib.SIEGER("synched",94);
	this.instance_3.setTransform(458,300,1,1,0,0,0,150,300);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(94).to({_off:false},0).to({x:150,startPosition:104},10,cjs.Ease.quadIn).wait(40).to({startPosition:144},0).to({x:-158.95},10,cjs.Ease.quadIn).to({_off:true},1).wait(94));

	// GUTES2
	this.instance_4 = new lib.GUTES2("synched",144);
	this.instance_4.setTransform(461,300,1,1,0,0,0,150,300);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(144).to({_off:false},0).to({x:150,startPosition:154},10,cjs.Ease.quadIn).wait(40).to({startPosition:194},0).to({scaleX:0.067,startPosition:199},5).to({_off:true},1).wait(49));

	// ANGEBOTE
	this.instance_5 = new lib.ANGEBOTE("synched",199);
	this.instance_5.setTransform(150,300,0.067,1,0,0,0,150,300);
...
p.nominalBounds = new cjs.Rectangle(-159.9,300,770.9,300);
// library properties:
lib.properties = {
	id: '30B79410E1D542DD895C5336CE59259E',
	width: 300,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/260415_AS_GFA_Banner_300x600_KW20_atlas_1.png", id:"260415_AS_GFA_Banner_300x600_KW20_atlas_1"}
	],
	preloads: []
};
...
an.compositions['30B79410E1D542DD895C5336CE59259E'] = {
